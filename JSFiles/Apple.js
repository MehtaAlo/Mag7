...
const mockFundamentals = {
    peRatio: (25 + Math.random() * 10).toFixed(1),                 // Apple-like placeholder
...
async function getAAPLHistory() {
    ...
    try {
        ...
        console.error("Error fetching AAPL history:", error);
        createChart(["N/A"], [0]);
    }
}
...
function createChart(labels, data) {
    let ctx = document.getElementById("aaplChart").getContext("2d");
...
// --- INITIALIZATION ---
getAAPLQuote();
setInterval(getAAPLQuote, 30000);
getAAPLHistory();